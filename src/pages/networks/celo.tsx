                ...
                <div className={clsx("folder-container-fg-network", title_font.className)}> 
                    <div className="folder-container-content">
                        <div className="code-block">
                            <span className={clsx("code-line", title_font.className)}>$ curl -Ls https://files.stakingdefense.org/file/sdl-snapshots/sdl-celo-snapshot.tar.lz4 | lz4 --decompress --to-stdout | tar --strip-components=4 --directory &quot;$CELO_DATA_DIR&quot;/celo -xvf -</span>
                        </div>
                    </div>
                    <div>
                        <a href="https://files.stakingdefense.org/file/sdl-snapshots/sdl-celo-snapshot.tar.lz4"><Download/></a>
                    </div>
                </div>
            </div>
          </div>
